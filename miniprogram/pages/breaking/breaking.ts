import { EventCardData, breakingEvents, formatNow, getLangButton, goTab, TabKey, toggleLang } from '../../utils/poly'

let clockTimer: number | null = null

Page({
  data: {
    tabValue: 'breaking' as TabKey,
    clockText: '',
    langBtnText: '简体中文 | EN',
    events: breakingEvents as EventCardData[],
  },
  ...
  onTabChange(e: WechatMiniprogram.CustomEvent<{ value: string }>) {
    goTab('breaking', String(e.detail.value))
  },
  ...
  onPullDownRefresh() {
    wx.showToast({ title: '突发列表已刷新', icon: 'success' })

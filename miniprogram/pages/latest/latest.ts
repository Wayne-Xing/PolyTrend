import { EventCardData, formatNow, getLangButton, goTab, latestEvents, TabKey, toggleLang } from '../../utils/poly'

let clockTimer: number | null = null

Page({
  data: {
    tabValue: 'latest' as TabKey,
    clockText: '',
    langBtnText: '简体中文 | EN',
    events: latestEvents as EventCardData[],
  },
  ...
  onTabChange(e: WechatMiniprogram.CustomEvent<{ value: string }>) {
    goTab('latest', String(e.detail.value))
  },
  ...
  onPullDownRefresh() {
    wx.showToast({ title: '最新列表已刷新', icon: 'success' })
